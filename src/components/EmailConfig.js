...
import { EmailConfigCardWiget } from "./Widgets";
...
const Template = ({ userName, subject, confirmationUrl }) => (
    ...
    <Email align="center" headCSS={emailHeadCSS} title={subject}>
      ...
      <Item align="center">
        <Box style={backgroundStyle}>
          ...
          <Item style={{ height: 25 }} />
          <Item>
            To access the optimal experience for shipment management, you only
            need to activate your account below.
          </Item>
